 ...
 */
public class PCALcalib_proj extends JFrame implements IDetectorListener, IDetectorProcessor, ActionListener {
...
//		    canvas.draw(exp,"same");
    ...
    public static void main(String[] args){    	
    	...
    	PCALcalib_proj detview = new PCALcalib_proj();
