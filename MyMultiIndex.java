 ...
 * @version 061714
 */
public class MyMultiIndex implements Serializable {
		...
		if(ind.length == indexDim) {
            ...
            if(ind.length == 4) { 
                if(this.checkIndex(0, ind[0])==false||
                   this.checkIndex(1, ind[1])==false||
                   this.checkIndex(2, ind[2])==false||
                   this.checkIndex(3, ind[3])==false) {
                	return -1;
                }
                return  + (ind[3]*dimSizes[2]*dimSizes[1]*dimSizes[0]) 
                		+ (ind[2]*dimSizes[1]*dimSizes[0]) 
                		+ (ind[1]*dimSizes[0]) 
                		+ ind[0];
            }
            ...
            if(ind.length == 5) { 
                if(this.checkIndex(0, ind[0])==false||
                   ...
                   this.checkIndex(2, ind[2])==false||
                   this.checkIndex(3, ind[3])==false||
                   this.checkIndex(4, ind[4])==false) {
                	return -1;
                }
                return  + (ind[4]*dimSizes[3]*dimSizes[2]*dimSizes[1]*dimSizes[0]) 
                		+ (ind[3]*dimSizes[2]*dimSizes[1]*dimSizes[0]) 
                		+ (ind[2]*dimSizes[1]*dimSizes[0]) 
                		+ (ind[1]*dimSizes[0]) 
                		+ ind[0];
            }
            ...
            if(ind.length == 6) { 
                if(this.checkIndex(0, ind[0])==false||
                   ...
                   this.checkIndex(3, ind[3])==false||
                   this.checkIndex(4, ind[4])==false||
                   this.checkIndex(5, ind[5])==false) {
                	return -1;
                }
                return  + (ind[5]*dimSizes[4]*dimSizes[3]*dimSizes[2]*dimSizes[1]*dimSizes[0]) 
                		+ (ind[4]*dimSizes[3]*dimSizes[2]*dimSizes[1]*dimSizes[0]) 
                		+ (ind[3]*dimSizes[2]*dimSizes[1]*dimSizes[0]) 
                		+ (ind[2]*dimSizes[1]*dimSizes[0]) 
                		+ (ind[1]*dimSizes[0]) 
                		+ ind[0];
