...
public class TestBug {
	...
	public TestBug() {
		// TODO Auto-generated constructor stub
			...
			g2.fit(fitfunc2); //creates graph with a name and 2 points
			test2.draw(g2);
			...
			hist1.fit(fitfunc3,"R"); //creates graph with a name and 2 points
	        ...
	        hist4.fit(fitfunc4); //creates graph with a name and 2 points
	        test4.draw(hist4);
